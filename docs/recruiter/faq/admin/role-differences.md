# :material-account-cog: リクルーター権限の各役割の違いについて知りたい
...
## :material-format-list-bulleted: 役割の詳細
...
### :material-alert-outline: **つながりサポーターをご登録する際の注意点**
...
[:material-account-plus: 公式リクルーター権限の追加方法を知りたい](add-recruiter.md)
