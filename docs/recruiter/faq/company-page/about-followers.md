...
![フォロワーのユーザー画面・管理画面での表示](images/web-follower-user-and-admin-view.png)
...
![TwitterでのカンパニーページURL共有例](images/web-twitter-company-page-share.png){ width="70%" style="display: block; margin: 0 auto;" }
