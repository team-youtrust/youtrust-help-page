# :material-lock-outline: 気になるリストのアクセスを管理したい
...
## :material-lock-outline: 気になるリストにアクセス制限をつけるには？
...
[:material-slack: Slackに通知を連携したい](../notification/slack-integration.md)

## :material-account-cog: **アクセスできるメンバーの設定方法**
...
### :material-alert-circle-outline: プライベートリストにアクセスできない時
