...
## :material-clipboard-check-outline: ご退職者様にご対応いただくこと

![退職時の対応フロー](images/web-after-resignation-flow.png)

### :material-progress-check: 1. ご自身がスカウトを送った方の進捗状況の更新
...
### :material-account-edit: 2. ご自身のマイページの所属名を変更
...
### :material-reply-outline: 3. 過去のスカウトに返信があった際の対応
...
[:material-chat-plus-outline: グループチャットを作りたい](../communication/group-chat.md)
