# :material-compare: スカウトとメッセージの違いを知りたい
...
### :material-send-lock: 有料スカウト（通数を消費する）
...
### :material-account-outline: ライトプランの送付範囲

![ライトプランのスカウト送付範囲](images/web-scout-scope-light-plan-diagram.png)

### :material-account-star: スタンダードプラン以上の送付範囲
