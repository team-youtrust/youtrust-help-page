...
[:material-delete-alert-outline: 利用規約に違反しているユーザー](../post/deletion-policy.md)を見つけたり不快な思いをされたりした場合は、「報告する」を押すと、運営に報告することができます。

また、「報告する」機能は、アカウントだけでなく、投稿やコメント・チャットルームに対しても行うことができます。

## :material-help-circle-outline: 「報告する」とどうなる？
...
## :material-account-alert: アカウントの報告手順
...
## :material-text-box-remove-outline: 投稿の報告手順
